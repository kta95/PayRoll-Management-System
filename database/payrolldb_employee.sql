...
CREATE TABLE `employee` (
  ...
  PRIMARY KEY (`emp_id`),
  KEY `fk_emp_posi_id_idx` (`emp_position_id`),
  CONSTRAINT `fk_emp_posi_id` FOREIGN KEY (`emp_position_id`) REFERENCES `position` (`position_id`)
...
-- Dump completed on 2022-07-09 14:41:08
